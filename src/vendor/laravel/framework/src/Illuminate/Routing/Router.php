...
=======
        ...
        //AdminLogin
        $this->get('adminlogin', 'AdminAuth\LoginController@showLoginForm')->name('adminlogin');
        $this->post('adminlogin', 'AdminAuth\LoginController@showLoginForm')->name('adminlogin');
>>>>>>> release/v2
    }
