...
class CourseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //fetch the id of the admin who created the course
        $var=Auth::guard('admin')->user()->id;
        
        
        //Bind the course admin id with course 
        ...
        DB::table('course_structure')->insert(['course_id' =>$course->id,'fixedstructure'=>null,'tempstructure'=>null]);
