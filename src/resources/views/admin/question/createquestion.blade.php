                ...
                <div class="panel-body">
                    ...
                    {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <input type="number" name="ques_id" class="form-control" value="{{$rand}}" readonly>
                        </div>
                        <div class="form-group">
                            <label>Quiz ID</label>
                            <input type="number" name="quiz_id" class="form-control" value="{{$quiz->quiz_id}}" readonly>
                        </div>
                        <div class="form-group">
                            <label>Level</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="button" id="matchmake" class="btn btn-default" value="Match making" ></input>
                        </div>
