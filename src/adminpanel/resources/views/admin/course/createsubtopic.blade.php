        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                	<form method="POST" action="/admin/{{$course->tid}}/createsubtopic" >
                	{{ csrf_field() }}
                       ...
                       <div class="form-group">
                            ...
                            <input type="number" name="tid" value= "{{$course->tid}}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>Course ID</label>
                            <input type="number" name="cid" value= "{{$course->course_id}}" class="form-control" readonly>
                        </div>
                		<div class="form-group">
